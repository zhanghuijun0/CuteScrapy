...
class Readability():
    ...
    def grabArticle(self):
        ...
        for elem in self.html.find_all(True):
            ...
            if elem.name == 'div':
                ...
                if not self.regexps['divToPElements'].search(s.decode('utf-8')):
                    elem.name = 'p'
    ...
    def cleanArticle(self, content):
        ...
        content = self.regexps['killBreaks'].sub("<br />", content.decode('utf-8'))
...
if __name__ == '__main__':
    url = "http://get.ftqq.com/122.get"
    htmlcode = urllib2.urlopen(url).read().decode('utf8')
    readability = Readability(htmlcode, url)
